...
{
    [CreateAssetMenu(menuName = "Configs/Gameplay/Entities/NewZombieConfig", fileName = "ZombieConfig")]
    public class ZombieConfig : EntityConfig
    {
        [field: SerializeField] public string PrefabPath { get; private set; } = "Entities/Zombie";
