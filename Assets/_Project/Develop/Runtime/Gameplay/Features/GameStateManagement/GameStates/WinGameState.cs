...
namespace _Project.Develop.Runtime.Gameplay.Logic.GameStateManagement
{
    public class WinGameState : IGameState
    {
        ...
        public WinGameState(StatisticService statisticService,
        ...
        public void OnEnter()
        {
            ...
            _walletService.AddGold(_progressionConfig.GetWinGoldReward());

            SaveProgress();

            _levelInterfacePresenter.ShowResult(true);
            _waitForKeyService.ListenForKeyCodeOnce(KeyCode.Space, BackToMenu);
        }
        ...
        private void BackToMenu()
            => _sceneSwitcherService.SwitchToScene(S._Project.Scenes.MainMenu);
